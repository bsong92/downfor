          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent placeholder:text-gray-400"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent resize-none placeholder:text-gray-400"
              />
            </div>
